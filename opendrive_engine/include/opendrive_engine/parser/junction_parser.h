#ifndef OPENDRIVE_ENGINE_JUNCTION_PARSER_H_
#define OPENDRIVE_ENGINE_JUNCTION_PARSER_H_
...
class JunctionParser : public ParserBase {
 public:
  JunctionParser() = default;
...
#endif  // OPENDRIVE_ENGINE_JUNCTION_PARSER_H_
