#ifndef OPENDRIVE_ENGINE_LANES_PARSER_H_
#define OPENDRIVE_ENGINE_LANES_PARSER_H_
...
class LanesParser : public ParserBase {
 public:
  LanesParser() = default;
...
#endif  // OPENDRIVE_ENGINE_LANES_PARSER_H_
